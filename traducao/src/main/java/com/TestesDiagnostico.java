...
public class TestesDiagnostico {
    ...
    public void cadastrarManual(String idioma) { 
        ...
        String sql = "INSERT INTO testes_diagnostico (titulo, conteudo, idioma) VALUES (?, ?, ?)";
    ...
    public void pesquisarManualTitulo() { 
        ...
        String sql = "SELECT * FROM testes_diagnostico WHERE titulo LIKE ?";
    ...
    public void pesquisaManualCodigo() { 
        ...
        String sql = "SELECT * FROM testes_diagnostico WHERE id = ?";
    ...
    public void editarManual() { 
        ...
        String selectSQL = "SELECT * FROM testes_diagnostico WHERE id = ?";
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				...
				String updateSQL = "UPDATE testes_diagnostico SET titulo = ?, conteudo = ? WHERE id = ?";
    ...
    public void excluirManual() { 
        ...
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				String deleteSQL = "DELETE FROM testes_diagnostico WHERE id = ?";
    ...
    public void listarManuais() {
		String sql = "SELECT id, titulo FROM testes_diagnostico ORDER BY id";

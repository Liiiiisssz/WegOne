...
public class ProcedimentoSeguranca {
    ...
    public void cadastrarManual(String idioma) { 
        ...
        String sql = "INSERT INTO procedimento_seguranca (titulo, conteudo, idioma) VALUES (?, ?, ?)";
    ...
    public void pesquisarManualTitulo() { 
        ...
        String sql = "SELECT * FROM procedimento_seguranca WHERE titulo LIKE ?";
    ...
    public void pesquisaManualCodigo() { 
        ...
        String sql = "SELECT * FROM procedimento_seguranca WHERE id = ?";
    ...
    public void editarManual() { 
        ...
        String selectSQL = "SELECT * FROM procedimento_seguranca WHERE id = ?";
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				...
				String updateSQL = "UPDATE procedimento_seguranca SET titulo = ?, conteudo = ? WHERE id = ?";
    ...
    public void excluirManual() { 
        ...
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				String deleteSQL = "DELETE FROM procedimento_seguranca WHERE id = ?";
   ...
   public void listarManuais() {
		String sql = "SELECT id, titulo FROM procedimento_seguranca ORDER BY id";

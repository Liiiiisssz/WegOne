...
public class ManualCondutaOperacoesSetoriais {
   ...
   public void cadastrarManual(String idioma) {
        ...
        String sql = "INSERT INTO manual_cos (titulo, conteudo, idioma) VALUES (?, ?, ?)";
    ...
    public void pesquisaManualTitulo() {
        ...
        String sql = "SELECT * FROM manual_cos WHERE titulo LIKE ?";
    ...
    public void pesquisaManualCodigo() { 
        ...
        String sql = "SELECT * FROM manual_cos WHERE ID = ?";
    ...
    public void editarManual() {
        ...
        String selectSQL = "SELECT * FROM manual_cos WHERE id = ?";
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				...
				String updateSQL = "UPDATE manual_cos SET titulo = ?, conteudo = ? WHERE id = ?";
    ...
    public void excluirManual() { 
        ...
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				String deleteSQL = "DELETE FROM manual_cos WHERE id = ?";
    ...
    public void listarManuais() {
		String sql = "SELECT id, titulo FROM manual_cos ORDER BY id";

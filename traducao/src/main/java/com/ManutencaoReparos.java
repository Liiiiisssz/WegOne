...
public class ManutencaoReparos {
    ...
    public void cadastrarManual(String idioma) { 
        ...
        String sql = "INSERT INTO manutencao_reparos (titulo, conteudo, idioma) VALUES (?, ?, ?)";
   	...
   	public void pesquisaManualTitulo() { 
        ...
        String sql = "SELECT * FROM manutencao_reparos WHERE titulo LIKE ?";
    ...
    public void pesquisaManualCodigo() { 
        ...
        String sql = "SELECT * FROM manutencao_reparos WHERE id = ?";
    ...
    public void editarManual() { 
        ...
        String selectSQL = "SELECT * FROM manutencao_reparos WHERE id = ?";
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				...
				String updateSQL = "UPDATE manutencao_reparos SET titulo = ?, conteudo = ? WHERE id = ?";
    ...
    public void excluirManual() { 
        ...
        try (Connection conn = Conexao.getConexao();
			...
			if (rs.next()) {
				String deleteSQL = "DELETE FROM manutencao_reparos WHERE id = ?";
